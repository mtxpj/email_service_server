...
public class AttachmentDownloadUrlsBuilder extends
		AttachmentDownloadUrlsBuilderBase<AttachmentDownloadUrlsBuilder> {
	public static AttachmentDownloadUrlsBuilder attachmentDownloadUrls() {
		return new AttachmentDownloadUrlsBuilder();
	}

	public AttachmentDownloadUrlsBuilder() {
		super(new AttachmentDownloadUrls());
	}

	public AttachmentDownloadUrls build() {
		return getInstance();
	}
}

class AttachmentDownloadUrlsBuilderBase<GeneratorT extends AttachmentDownloadUrlsBuilderBase<GeneratorT>> {
	private AttachmentDownloadUrls instance;

	protected AttachmentDownloadUrlsBuilderBase(AttachmentDownloadUrls aInstance) {
		instance = aInstance;
	}
	...
	public static class AddresseeListBuilderBase<GeneratorT extends AddresseeListBuilderBase<GeneratorT>> {
