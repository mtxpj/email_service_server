...
public class EmailBuilder extends EmailBuilderBase<EmailBuilder> {
...
class EmailBuilderBase<GeneratorT extends EmailBuilderBase<GeneratorT>> {
	...
	public AddedAttachmentDownloadUrlsAttachmentDownloadUrlsBuilder withAddedAttachmentDownloadUrls() {
		...
		return new AddedAttachmentDownloadUrlsAttachmentDownloadUrlsBuilder(obj);
	}
	...
	public GeneratorT withAddedAddresseeList(AddresseeList aValue) {
		...
		((ArrayList<AddresseeList>) instance.getAddresseeLists()).add(aValue);
	...
	public class AddedAddresseeListAddresseeListBuilder extends
			AddresseeListBuilderBase<AddedAddresseeListAddresseeListBuilder> {
		public AddedAddresseeListAddresseeListBuilder(AddresseeList aInstance) {
			super(aInstance);
		}
